...
const printeazaProdus = function (product) {
  ...
  for (i = 0; i < product.length; i++) {
    ...
    // const addHover = document.querySelectorAll(".hover-add-to-cart");

    // const prodsWrapperLength = prodsWrapper.childElementCount;
    // addHover.forEach(function (el) {
    //   el.addEventListener("click", function () {
    //     for (let i = 0; i < prodsWrapperLength; i++) {
    //       addToCart(product[i].internalName);
